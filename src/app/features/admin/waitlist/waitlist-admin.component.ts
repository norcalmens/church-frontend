...
@Component({
  ...
  styles: [`
    ...
    ::ng-deep .waitlist-admin .p-datatable .p-datatable-thead > tr > th { background: var(--retreat-grad-nav); color: var(--retreat-cream); }
    .position { font-weight: 700; color: var(--retreat-teal-dark); }
