...
@Component({
  ...
  styles: [`
    ...
    .hero-section {
      ...
      color: var(--retreat-cream); margin-bottom: 2rem;
    ...
    .loading-state, .empty-state {
      ...
      h3 { color: var(--retreat-teal-dark); margin: 0 0 0.5rem; }
    ...
    .zoom-card-header { display: flex; align-items: center; gap: 0.65rem; margin-bottom: 0.5rem;
      i { font-size: 1.5rem; color: var(--retreat-sunset); }
      h3 { color: var(--retreat-teal-dark); margin: 0; font-size: 1.25rem; font-weight: 700; }
    }
    .zoom-schedule {
      color: var(--retreat-teal-dark); font-weight: 600; margin: 0.25rem 0 0.75rem;
      display: flex; align-items: center; gap: 0.5rem;
      i { color: var(--retreat-gold); font-size: 0.95rem; }
    }
    ...
    .zoom-info {
      ...
      div { padding: 2px 0; }
      strong { color: var(--retreat-teal-dark); margin-right: 0.4rem; }
    }
    .zoom-join { text-decoration: none; }
    ::ng-deep .zoom-btn.p-button {
      width: 100%; justify-content: center;
      background: var(--retreat-sunset) !important; border-color: var(--retreat-sunset) !important; color: #fff !important;
      font-weight: 700;
      &:hover { background: var(--retreat-sunset) !important; border-color: var(--retreat-sunset) !important; }
    }
  `]
})
